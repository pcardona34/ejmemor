...
+"</span> &ndash; &copy; 2021 P<span class=\"w3-hide-small\">atrick </span>Cardona \n -\n      <span class=\"w3-hide-small\">Hébergement&nbsp;: </span><a title=\"site hébergeur\" \n      href=\"https://pages.github.com/\" \n      target=\"_blank\" rel=\"noreferrer noopener\" style=\"text-decoration: none\">\n      gh-pages\n      </a>\n    </footer>";},"useData":true});},{"hbsfy/runtime":23}],31:[function(require,module,exports){exports.masquer_aide=function(){$("#aide").hide();};exports.afficher_aide=function(){$("#aide").show();};exports.alterner_section_aide=function(id){let section=document.getElementById(id);if(section.className.indexOf("w3-show")==-1){section.className+=" w3-show";}else{section.className=section.className.replace(" w3-show","");}};},{}],32:[function(require,module,exports){const Popup=require('./messageModule.js').Popup;const popup=new Popup();var exercice={"series":[],"cartes":0,"i":0};exercice.init=function(series){this.series=series;this.i=0;this.cartes=0;};exercice.masquerBoutons=function(){$(".reaction").hide();$("#retourner").hide();};exercice.finir=function(){$("#boite").html("<i class=\"icon-smile\"><br />Série mémorisée !");$("#boite").toggleClass("bleu");$("#retourner").hide();$("#info-cartes").hide();};exercice.commencer=function(){$("#retourner").show();$("#actions").hide();$("#info-cartes").show();this.cartes=this.series.length;if(this.cartes==0){this.finir();}else{this.series.sort(function(){return 0.5-Math.random()});$("#boite").html(this.series[this.i]['ques']);$("#boite").toggleClass("vert");$("#boite").toggleClass("blanc");}};exercice.retourner=function(){$("#retourner").hide();$("#boite").html(this.series[this.i]['ans']);$("#boite").toggleClass("blanc");$("#boite").toggleClass("vert");$(".reaction").show();};exercice.jenelesaispasencore=function(){$(".reaction").hide();$("#retourner").show();this.commencer();};exercice.jelesaisdeja=function(){$(".reaction").hide();$("#retourner").show();this.series.splice(this.i,1);this.cartes=this.series.length;$("#nombre").html(this.cartes);if(this.cartes==0){this.finir();}else{this.commencer();}};exports.exercice=exercice;},{"./messageModule.js":34}],33:[function(require,module,exports){exports.filtrer=function(IDListe,motif){let filtre,ul,li,a,i,txtValue;filtre=motif.toUpperCase();ul=document.getElementById(IDListe);li=ul.getElementsByTagName("li");for(i=0;i<li.length;i++){a=li[i].getElementsByTagName("a")[0];txtValue=a.textContent||a.innerText;if(txtValue.toUpperCase().indexOf(filtre)>-1){li[i].style.display="";}else{li[i].style.display="none";}}}},{}],34:[function(require,module,exports){const infos=require('../../../static/config/popups.json').infos;class Popup{constructor(msgid='000'){this.msgid=msgid;this.message="Un message...";this.titre="Titre";}}
...
return null;});Handlebars.registerHelper("interpreteNiveau",function(sChiffre){let niveau="";let etalon=sChiffre;switch(etalon){case"6":niveau="Sixième";break;case"5":niveau="Cinquième";break;case"4":niveau="Quatrième";break;case"3":niveau="Troisième";break;case"2":niveau="Seconde";break;case"1":niveau="Première";break;default:return"Tous";}
...
+" w3-xlarge\" data-navigo>"
+((stack1=((helper=(helper=lookupProperty(helpers,"icone")||(depth0!=null?lookupProperty(depth0,"icone"):depth0))!=null?helper:alias2),(typeof helper===alias3?helper.call(alias1,{"name":"icone","hash":{},"data":data,"loc":{"start":{"line":22,"column":82},"end":{"line":22,"column":93}}}):helper)))!=null?stack1:"")
...
+" w3-right\" data-navigo>"
+((stack1=((helper=(helper=lookupProperty(helpers,"icone")||(depth0!=null?lookupProperty(depth0,"icone"):depth0))!=null?helper:alias2),(typeof helper===alias3?helper.call(alias1,{"name":"icone","hash":{},"data":data,"loc":{"start":{"line":61,"column":105},"end":{"line":61,"column":116}}}):helper)))!=null?stack1:"")
+" "
+alias4(((helper=(helper=lookupProperty(helpers,"legende")||(depth0!=null?lookupProperty(depth0,"legende"):depth0))!=null?helper:alias2),(typeof helper===alias3?helper.call(alias1,{"name":"legende","hash":{},"data":data,"loc":{"start":{"line":61,"column":117},"end":{"line":61,"column":128}}}):helper)))
...
+" w3-xlarge\" data-navigo>"
+((stack1=((helper=(helper=lookupProperty(helpers,"icone")||(depth0!=null?lookupProperty(depth0,"icone"):depth0))!=null?helper:alias2),(typeof helper===alias3?helper.call(alias1,{"name":"icone","hash":{},"data":data,"loc":{"start":{"line":20,"column":82},"end":{"line":20,"column":93}}}):helper)))!=null?stack1:"")
+"</a>\n";},"6":function(container,depth0,helpers,partials,data){var stack1,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
...
+" w3-right\" data-navigo>"
+((stack1=((helper=(helper=lookupProperty(helpers,"icone")||(depth0!=null?lookupProperty(depth0,"icone"):depth0))!=null?helper:alias2),(typeof helper===alias3?helper.call(alias1,{"name":"icone","hash":{},"data":data,"loc":{"start":{"line":29,"column":91},"end":{"line":29,"column":102}}}):helper)))!=null?stack1:"")
+" "
+alias4(((helper=(helper=lookupProperty(helpers,"legende")||(depth0!=null?lookupProperty(depth0,"legende"):depth0))!=null?helper:alias2),(typeof helper===alias3?helper.call(alias1,{"name":"legende","hash":{},"data":data,"loc":{"start":{"line":29,"column":103},"end":{"line":29,"column":114}}}):helper)))
+"</a>\n";},"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data,blockParams,depths){var stack1,helper,alias1=depth0!=null?depth0:(container.nullContext||{}),lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
...
+"\" class=\"w3-bar-item w3-button w3-light-gray w3-border-bottom\" data-navigo>\n  "
...
+" w3-xlarge\" data-navigo>"
+((stack1=((helper=(helper=lookupProperty(helpers,"icone")||(depth0!=null?lookupProperty(depth0,"icone"):depth0))!=null?helper:alias2),(typeof helper===alias3?helper.call(alias1,{"name":"icone","hash":{},"data":data,"loc":{"start":{"line":31,"column":82},"end":{"line":31,"column":93}}}):helper)))!=null?stack1:"")
...
+" w3-right\" data-navigo>"
+((stack1=((helper=(helper=lookupProperty(helpers,"icone")||(depth0!=null?lookupProperty(depth0,"icone"):depth0))!=null?helper:alias2),(typeof helper===alias3?helper.call(alias1,{"name":"icone","hash":{},"data":data,"loc":{"start":{"line":40,"column":91},"end":{"line":40,"column":102}}}):helper)))!=null?stack1:"")
+" "
+alias4(((helper=(helper=lookupProperty(helpers,"legende")||(depth0!=null?lookupProperty(depth0,"legende"):depth0))!=null?helper:alias2),(typeof helper===alias3?helper.call(alias1,{"name":"legende","hash":{},"data":data,"loc":{"start":{"line":40,"column":103},"end":{"line":40,"column":114}}}):helper)))
+"</a>\n";},"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data,blockParams,depths){var stack1,helper,alias1=depth0!=null?depth0:(container.nullContext||{}),lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
...
+alias4(((helper=(helper=lookupProperty(helpers,"titre")||(depth0!=null?lookupProperty(depth0,"titre"):depth0))!=null?helper:alias2),(typeof helper===alias3?helper.call(alias1,{"name":"titre","hash":{},"data":data,"loc":{"start":{"line":16,"column":7},"end":{"line":16,"column":16}}}):helper)))
+"</h3>\n  </div>\n </div>\n\n <div class=\"w3-center\" id=\"info-cartes\">\n  <span id=\"nombre\">"
+alias4(((helper=(helper=lookupProperty(helpers,"cartes")||(depth0!=null?lookupProperty(depth0,"cartes"):depth0))!=null?helper:alias2),(typeof helper===alias3?helper.call(alias1,{"name":"cartes","hash":{},"data":data,"loc":{"start":{"line":21,"column":20},"end":{"line":21,"column":30}}}):helper)))
+"</span> carte(s) à mémoriser\n </div>\n\n<div class=\"w3-bar\">\n  <button title=\"Je ne le sais pas encore!\" onclick=\"exercice.jenelesaispasencore()\"\n  class=\"w3-bar-item w3-button w3-red reaction\">\n  <b><i class='icon-fermer'></i></b>\n  </button>\n\n  <button title=\"Retourner la carte\" onclick=\"exercice.retourner()\"\n  class=\"w3-bar-item w3-button w3-teal\" id=\"retourner\">\n  <i class='icon-voir'></i>\n  </button>\n\n  <button title=\"Je le sais déjà!\" onclick=\"exercice.jelesaisdeja()\"\n  class=\"w3-bar-item w3-button w3-green reaction\">\n  <i class='icon-finir'></i>\n  </button>\n</div>\n\n\n <!-- <div class=\"w3-card-4\"> -->\n  <div id=\"boite\" class=\"w3-container w3-padding w3-center blanc\">\n  <div id=\"actions\" class=\"w3-center\">\n   <button title=\"Cliquez sur la pile pour commencer.\" onclick=\"exercice.commencer()\">\n   <img src=\"./static/images/exercice/deck.png\" alt=\"Pile\" width=\"50%\" height=\"auto\" />\n   Commencer...\n   </button>\n  </div>\n  </div>\n <!-- </div> --> \n\n</div>\n";},"useData":true});},{"hbsfy/runtime":23}],48:[function(require,module,exports){var HandlebarsCompiler=require('hbsfy/runtime');module.exports=HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data){var helper,alias1=depth0!=null?depth0:(container.nullContext||{}),alias2=container.hooks.helperMissing,alias3="function",alias4=container.escapeExpression,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
...
return undefined};return"  <li><a href=\"#!choix/"
...
+"/#!choix/"
+alias4(((helper=(helper=lookupProperty(helpers,"cible")||(depth0!=null?lookupProperty(depth0,"cible"):depth0))!=null?helper:alias2),(typeof helper===alias3?helper.call(alias1,{"name":"cible","hash":{},"data":data,"loc":{"start":{"line":55,"column":55},"end":{"line":55,"column":64}}}):helper)))
+"/"
+alias4(((helper=(helper=lookupProperty(helpers,"did")||(depth0!=null?lookupProperty(depth0,"did"):depth0))!=null?helper:alias2),(typeof helper===alias3?helper.call(alias1,{"name":"did","hash":{},"data":data,"loc":{"start":{"line":55,"column":65},"end":{"line":55,"column":72}}}):helper)))
